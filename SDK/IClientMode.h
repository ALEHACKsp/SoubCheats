...
public:
    ...
    {
        typedef void(__thiscall* tKeyboardInputEnabled)(void*, unsigned int, bool);
        return Utils::GetVFunc<tKeyboardInputEnabled>(this, 31)(this, vguiPanel, State);
    }

    void SetMouseInputEnabled(unsigned int vguiPanel, bool State)
    {
        typedef void(__thiscall* tMouseInputEnabled)(void*, unsigned int, bool);
        return Utils::GetVFunc<tMouseInputEnabled>(this, 32)(this, vguiPanel, State);
    }
};
